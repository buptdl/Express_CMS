...
//连接到数据库
	...
	if (isset($_POST['filters']))
		...
		$filter='';
	$query="SELECT leader_user AS author,leaderness,publish_num,publish_floor,date(FROM_UNIXTIME(date)) AS publish_date FROM pris_users_leader ".$filter.'  ORDER BY date DESC,leaderness desc limit 0,10';
