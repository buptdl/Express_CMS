...
//连接到数据库
   /* define('MYSQL_HOST','59.64.138.184');
	...
	if (isset($_POST['filters']))
		...
		$filter='';
	$query="SELECT abnormal_user AS author,sensitive_words,date(FROM_UNIXTIME(date)) AS publish_date,post_id FROM pris_users_abnormal ".$filter.'  ORDER BY date DESC limit 0,10';
