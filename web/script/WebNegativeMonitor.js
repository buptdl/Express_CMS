WebNegativeMonitor=function(){
	this.init=function(config){
		var store= new Ext.data.JsonStore({
			url:'PHP/WebWordNegative.php',
			root:'data',
			totalProperty:'total',
			fields:[{ name: 'id'},
					{ name: 'word', type: 'char'}
		...
		var WebData=new Ext.data.JsonStore({
			...
			fields:[
			     ...
			     {name: 'negative_words',type: 'string'},
...
//测试实现表格的自动伸缩功能
			columns: [new Ext.grid.RowNumberer({width: 20}),
					...
					{ header: '不良词',dataIndex: 'negative_words',width: 100,sortable:true },
		...
		/*	cm: new Ext.grid.ColumnModel({
				...
				columns: [
					...
					{ header: '敏感词',dataIndex: 'negative_words',width: 150,sortable:true },
